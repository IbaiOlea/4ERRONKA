...
if ($result->num_rows > 0) {
    ...
    echo "<tr style='background-color: lightgray;'>
          ...
          while($row = $result->fetch_assoc()) {
            ...
            echo "<td>
                    <button style='background-color: green; color: white; border: none; padding: 8px 12px; cursor: pointer; font-size: 14px; margin: 2px;'>Erosi</button>
                    <button style='background-color: blue; color: white; border: none; padding: 8px 12px; cursor: pointer; font-size: 14px; margin: 2px;'>Saskira Gehitu</button>
                  </td>";
            echo "</tr>";
        }
